export default function Bills() {
  return (
    <div className="rounded-[12px] flex flex-col gap-[12px] bg-white pt-[20px] pr-[24px] pb-[20px] pl-[24px]">
      ...
      <div className="relative isolate flex flex-col">
        <div className="absolute inset-0 w-full h-full bg-green translate-x-[-5px] z-[0] rounded-[8px] z-10"></div>
      ...
      <div className="relative isolate flex flex-col">
        <div className="absolute inset-0 w-full h-full bg-yellow translate-x-[-5px] z-[0] rounded-[8px] z-10"></div>
        <div className="bg-beige-100 flex justify-between pl-[16px] pr-[16px] pt-[20px] pb-[20px] rounded-[8px] z-20">
      ...
      <div className="relative isolate flex flex-col">
        <div className="absolute inset-0 w-full h-full bg-cyan translate-x-[-5px] z-[0] rounded-[8px] z-10"></div>
        <div className="bg-beige-100 flex justify-between pl-[16px] pr-[16px] pt-[20px] pb-[20px] rounded-[8px] z-20">
