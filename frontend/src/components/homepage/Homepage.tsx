    ...
    >
      ...
      <div className="flex flex-col gap-[32px] xl:pt-[24px] xl:pl-[16px] xl:pr-[48px] w-full xl:ml-[var(--sidebar-width)]">
        ...
        <div className="flex flex-col gap-[16px] md:grid md:grid-cols-3">
          <Tile variant="dark" title="Current Balance" value={userData?.balance || "-"}></Tile>
          <Tile variant="light" title="Income" value={userData?.income || "-"}></Tile>
          <Tile variant="light" title="Expenses" value={userData?.expenses || "-"}></Tile>
        </div>
