...
function Sidebar() {
  ...
  useEffect(() => {
    const sidebarWidth = minimized ? '88px' : '300px'
    ...
    <>
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className={`fixed left-0 will-change-[width] bg-grey-900 rounded-r-[16px] h-full flex-col justify-between p-[32px] pb-[64px] text-preset-3 text-gray-300 hidden xl:flex z-[1000000] ${
